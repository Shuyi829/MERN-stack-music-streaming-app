  ...
  return (
    <div>
      ...
      <div className="search_box">
        <Input placeholder="Search Music" className="input_search" onChange={e=>setSearchText(e.target.value)}/>
        ...
        <List
          ...
          renderItem={item => (
            <List.Item>
              ...
              />
              <List.Item
            actions={[<a key="list-loadmore-edit" onClick={addMusic} item_name={item.name} item_image={item.album.images[0].url} item_uri={item.uri}>Add Music</a>]}
          ></List.Item>
            </List.Item>
          )}
        />
      ...
      <div className="love_list">
          ...
          renderItem={item => (
            <List.Item>
              ...
              />
              <List.Item
            actions={[<a key="list-loadmore-edit" onClick={playMusic} item_uri={item.uri}>Play</a> ,<a key="list-loadmore-edit" onClick={deleteMusic} item_id={item._id}>Delete</a>]}
          ></List.Item>
            </List.Item>
          )}
        />
